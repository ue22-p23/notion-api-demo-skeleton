...
from notion_helpers import list_tasks, get_task_details, update_task_status, add_text_to_task_body

def main():
    """
    Main function that handles the user interaction with the program.

    The function prompts the user for an action and performs the corresponding operation based on the user's input.
